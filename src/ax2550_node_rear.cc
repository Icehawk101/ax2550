...
int main(int argc, char **argv) 
{
    ...
    std::string port;
    n.param("serial_port", port, std::string("/dev/serial/by-id/usb-FTDI_FT232R_USB_UART_A501IMQF-if00-port0")); 
    ...
    // Encoder Publisher
    encoder_pub = n.advertise<ax2550::Encoders>("rear_encoders", 5);
    
    // cmd_vel Subscriber
    ros::Subscriber sub = n.subscribe("rear_cmd_vel", 1, cmd_velCallback);
